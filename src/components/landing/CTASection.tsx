    ...
    <div className="border border-b2 py-[72px] px-[72px] max-sm:px-7 max-sm:py-10 relative overflow-hidden">
      ...
      <div className="grid grid-cols-[1fr_auto] max-lg:grid-cols-1 gap-16 items-center">
        <div>
          ...
          <h2 className="font-heading text-[clamp(1.8rem,2.5vw,2.8rem)] font-light tracking-[-0.015em] leading-[1.15] mb-4 text-t1">Start With Just $500.<br />The Ceiling Is Yours.</h2>
          <p className="text-[0.9rem] text-t3 leading-[1.85] max-w-[480px]">Join over 1,200 investors, athletes, entertainers, and corporate brands who have committed capital to Adams Streett Partners. BTC, ETH, and USDC accepted.</p>
        </div>
        <div className="flex flex-col gap-3 items-end max-lg:items-start flex-shrink-0">
          ...
          <span className="font-mono text-[0.65rem] text-t4 text-center">From $500 · Not available to US persons</span>
        </div>
      </div>
    </div>
  </div>
